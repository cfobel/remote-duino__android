...
public class RemoteCommand implements Serializable {
    ...
    public RemoteCommand(String label, String protocol, String code) {
        /*
         * Create a new RemoteCommand instance based specific protocol and code
         * values.
         */
        super();
        this.label = label;
    ...
    public RemoteCommand(String label, String response) throws IOException {
        /*
         * Create a new RemoteCommand instance based on response from "learn"
         * command. We parse the "learn" response to obtain the protocol and
         * code values.
         */
        super();
        this.label = label;
        String patternstr__code = "<h2>\\s*(.*?)\\s*</h2>";
        Pattern pattern__code = Pattern.compile(patternstr__code,
                Pattern.DOTALL | Pattern.MULTILINE);
        String patternstr__protocol = "Received\\s+(NEC|SONY|RC6|RC5)\\[(\\d+)\\]:";
        Pattern pattern__protocol = Pattern.compile(patternstr__protocol,
                Pattern.DOTALL | Pattern.MULTILINE);
    ...
    public static RemoteCommand learn_command(String label,
            WebArduinoIRDevice irDevice) throws Exception {
        /*
