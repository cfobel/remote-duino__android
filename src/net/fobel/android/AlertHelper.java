...
public class AlertHelper {
	public static void showTextInputAlert(Context context, String message, AlertOnClickI positiveListener){
		showTextInputAlert(context, message, "Ok", "Cancel", positiveListener, createCancelOnClickListener());
	}
	
	public static void showTextInputAlert(Context context, String message, String positiveButtonText, String negativeButtonText, final AlertOnClickI positiveListener, final AlertOnClickI negativeListener){
